    ...
    $.fn.jTabs = function(options) {
        ...
        return this.each(function() {
            ...
            function showTab(num) {
                var _trigAct = $(tabIndex[num]).attr('data-trigger');
                if (typeof _trigAct == 'string') {
                    if (typeof onShowTab[_trigAct] == 'function') onShowTab[_trigAct]($(tabIndex[num]));
                }
                //onShowTab
                if (typeof tabIndex[num] != 'undefined') {
