...
class BusinessTypeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['BusinessType'];
			if($model->save())
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('BusinessType');
	...
	{
		$model=new BusinessType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['BusinessType']))
			$model->attributes=$_GET['BusinessType'];
		
		$this->pageTitle = 'Business Type List | '.Yii::app()->params['name'];
	...
	{
		$model=BusinessType::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param BusinessType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='business-type-form')
		{
	...
	public function actionChangeStatus(){
		...
		$statusDetails = BusinessType::model()->findByPk($id); 
	...
	public function actionGetTypeData(){
		...
		$typeDetails = BusinessType::model()->findByPk($id);
		$resp = array('id'=>$typeDetails->business_type_id,'name'=>$typeDetails->business_name);
	...
	public function actionCreateOrUpdate(){
		...
		if($id == '' || $id == 0){
			...
			$typeDetails = BusinessType::model()->findByPk($id);
			$typeDetails->business_name = $name;
