...
class CustomerSourceController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CustomerSource']))
		{
			$model->attributes=$_POST['CustomerSource'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->customer_source_id));
		}
	...
	{
		$this->redirect(array('admin'));
		$dataProvider=new CActiveDataProvider('CustomerSource');
	...
	{
		$this->layout="main";
		$model=new CustomerSource('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CustomerSource']))
			$model->attributes=$_GET['CustomerSource'];
			
		$this->pageTitle = 'Customer Source List | '.Yii::app()->params['name'];
	...
	{
		$model=CustomerSource::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param CustomerSource $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='customer-source-form')
		{
	...
	public function actionChangeStatus(){
		...
		$statusDetails = CustomerSource::model()->findByPk($id); 
	...
	public function actionGetTypeData(){
		...
		$typeDetails = CustomerSource::model()->findByPk($id);
		$resp = array('id'=>$typeDetails->customer_source_id,'name'=>$typeDetails->source_name);
