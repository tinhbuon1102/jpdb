...
class FormTypeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['FormType'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->form_type_id));
		}
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('FormType');
	...
	{
		$model=new FormType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['FormType']))
			$model->attributes=$_GET['FormType'];
			
		$this->pageTitle = 'Form Type List | '.Yii::app()->params['name'];
	 ...
	 * @return FormType the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=FormType::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param FormType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='form-type-form')
		{
	...
	public function actionChangeStatus(){
		...
		$statusDetails = FormType::model()->findByPk($id); 
	...
	public function actionGetTypeData(){
		...
		$typeDetails = FormType::model()->findByPk($id);
		$resp = array('id'=>$typeDetails->form_type_id,'name'=>$typeDetails->form_type_name);
	...
	public function actionCreateOrUpdate(){
		...
		if($id == '' || $id == 0){
			...
			$typeDetails = FormType::model()->findByPk($id);
			$typeDetails->form_type_name = $name;
