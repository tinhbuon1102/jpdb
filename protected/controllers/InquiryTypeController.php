...
class InquiryTypeController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['InquiryType'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->inquiry_id));
		}
	...
	public function actionIndex()
	{
		...
		$dataProvider=new CActiveDataProvider('InquiryType');
	...
	{
		$model=new InquiryType('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['InquiryType']))
			$model->attributes=$_GET['InquiryType'];
		
		$this->pageTitle = 'Inquiry Type List | '.Yii::app()->params['name'];
	 ...
	 * @return InquiryType the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=InquiryType::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param InquiryType $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='inquiry-type-form')
		{
	...
	public function actionChangestatus(){
		...
		$statusDetails = InquiryType::model()->findByPk($id);
	...
	public function actionGetTypeData(){
		...
		$typeDetails = InquiryType::model()->findByPk($id);
		$resp = array('id'=>$typeDetails->inquiry_id,'name'=>$typeDetails->inquiry_name);
