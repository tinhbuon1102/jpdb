...
class SecurityController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Security']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->security_id));
		}
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Security']))
			$model->attributes=$_GET['Security'];
		
		$this->pageTitle = 'Security List | '.Yii::app()->params['name'];
	...
	{
		$model=Security::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Security $model the model to be validated
	 */
	...
	public function actionChangeStatus(){
		...
		$statusDetails = Security::model()->findByPk($id); 
	...
	public function actionGetTypeData(){
		...
		$typeDetails = Security::model()->findByPk($id);
		$resp = array('id'=>$typeDetails->security_id,'name'=>$typeDetails->security_name);
	...
	public function actionCreateOrUpdate(){
		...
		if($id == '' || $id == 0){
			...
			$typeDetails = Security::model()->findByPk($id);
			$typeDetails->security_name = $name;
