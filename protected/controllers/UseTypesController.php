...
class UseTypesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['UseTypes']))
		{
			$model->attributes=$_POST['UseTypes'];
			if($model->save())
	...
	{
		$this->redirect(array('admin'));
		$dataProvider=new CActiveDataProvider('UseTypes');
	...
	{
		$model=new UseTypes('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['UseTypes']))
			$model->attributes=$_GET['UseTypes'];
		
		$this->pageTitle = 'Use Type List | '.Yii::app()->params['name'];
	 ...
	 * @return UseTypes the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=UseTypes::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param UseTypes $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='use-types-form')
		{
	...
	public function actionChangeStatus(){
		...
		$statusDetails = UseTypes::model()->findByPk($id); 
	...
	public function actionGetTypeData(){
		...
		$typeDetails = UseTypes::model()->findByPk($id);
		$resp = array('id'=>$typeDetails->user_type_id,'name'=>$typeDetails->user_type_name);
	...
	public function actionCreateOrUpdate(){
		...
		if($id == '' || $id == 0){
			...
			$typeDetails = UseTypes::model()->findByPk($id);
			$typeDetails->user_type_name = $name;
