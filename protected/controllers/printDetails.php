...
.sheet { width: 277mm; height: auto; /* 1mm余裕をもたせる */ page-break-after: always; position: relative; }
...
<div class="sheet_wrapper">
  <section class="sheet cover" style="height: 189mm;">
    <div class="client">
		<?php
			$prosalData = ProposedArticle::model()->findByPK($requestData['hdnProArticleId']);
...
// 				}
            ...
            <tr class="row_second">
              ...
              <td class="label_5"><?php echo $floorId['total_rent_price'] != "" && $floorId['total_rent_price'] != 0 ? Yii::app()->controller->renderPrice($floorId['total_rent_price'])/*.'円'*/ : '-'; ?></td>
              <!--total rent fee-->
...
<div class="sheet_wrapper">
  <section class="sheet"> <?php echo '<span class="build_title">'.$buildingNumber.'.'.$buildCart['name']."<span>"; ?><br>
	<div class="text-box">
	<?php 
		$url = "https://maps.googleapis.com/maps/api/geocode/json?latlng={$lat},{$lng}&key={$gApiKey}&language=ja";
		$resp_json = file_get_contents($url);
		$resp = json_decode($resp_json, true);
		if($resp['status']=='OK' && $resp['results'] && $resp['results'][1] && $resp['results'][1]['formatted_address']) {
			echo $resp['results'][1]['formatted_address'];
		}else echo $address;?>
	</div>
  ...
  <section class="sheet">
    <table class="building-profile single-info">
      ...
      <tr>
        ...
        <div style="padding-top:15px" class="plan-img"><?php
