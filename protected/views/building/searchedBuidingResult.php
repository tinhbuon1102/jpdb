            ...
            <dl class="room-data clearfix">
                ...
                <dd class="details">
                    ...
                    <table class="room-table">
						...
						?>
                        	<tr class="trFloor <?php $this->changeColor($list->floor_id); ?> <?php echo $floor->fixed_floor ? 'fixed_floor_mass' : ''?>"  data-href='<?php echo Yii::app()->createUrl('building/singleBuilding',array('id'=>$list->floor_id)); ?>'>
                            	<td>
                                	<input type="hidden" name="hdnBuildingId" id="hdnBuildingId" class="hdnBuildingId" value="<?php echo $buildingList['building_id']; ?>" />
