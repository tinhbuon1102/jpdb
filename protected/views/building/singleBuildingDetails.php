                        ...
                        <div class="access_box">
                        	<dl class="access">
                                ...
                                <dd class="nearStationRoute">
                                    ...
                                    ?>
                                    	<li>
											<?php echo str_replace('station', '', $station['station']); ?><?php echo "駅"; ?>
                                            <span>
												<?php
                                                if($station['time'] != ""){
                                    ...
                                    <?php if(!empty($all_floors)){
                                        ...
                                        ?>
                                            <span class="<?= $span_class?> negFloor floorEmpt"><input type="checkbox" name="targetFloorId[]" id="" class="targetFloorId <?= $class_floor ?>" value="<?= $all_floor['floor_id'] ?>">
                                            	<?php echo HelperFunctions::translateBuildingValue('floor_up_down', $buildingDetails, $all_floor);?>
                                             	<?php echo HelperFunctions::translateBuildingValue('roomname', $buildingDetails, $all_floor);?>
                                            </span>
                                        <?php
                                        }
                                    } ?>
    ...
    <div class="box-content">
      <form name="frmAddRentNegotiation" id="frmAddRentNegotiation" class="frmAddRentNegotiation" data-action="<?php echo Yii::app()->createUrl('building/saveRentNegotiation'); ?>" onkeypress="return event.keyCode != 13;">
        <table>
          ...
          <tr>
            <td>
				<?php echo Yii::app()->controller->__trans('対象フロア'); ?><br/>
            	<span>
