        ...
        <div class="tabs_content">
            ...
            <div class="tab_con" style="display: <?PHP echo isset($_GET['show']) && $_GET['show'] == 3 ? 'block' : 'none'; ?>;">
                ...
                if(isset($customerDetails->customer_id) && $customerDetails->customer_id != ''){
					...
					$proposedArticlesList = Yii::app()->db->createCommand('SELECT * FROM proposed_article where customer_id = '.$customerDetails->customer_id)->queryAll();
                ...
                <div class="article-list propertyActionList">
                	<div class="action-list">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('building/searchBuilding',array('samecond'=>$condId)); ?>">
                    	...
                    	<tbody>
                        	<tr>
                            	<th>
									...
									<?php echo Yii::app()->controller->__trans('building'); ?>(<?php echo count($floors);?>
