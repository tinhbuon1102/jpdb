...
/* @var $data FacedStreet */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('faced_street_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->faced_street_id), array('view', 'id'=>$data->faced_street_id)); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('add_on')); ?>:</b>
	<?php echo CHtml::encode($data->add_on); ?>
	<br />
