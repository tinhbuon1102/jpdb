...
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/massupdate/js/floor_list_update.js"></script>
<style>
...
<div id="main">
	...
	<tr>
		...
		<th scope="col" col="f_no" class="w" style="background: #FFB8B9">フロアID</th>
		...
		<th scope="col" col="f_price_m_shiki_opt" class="w" style="background: #FFB8B9">deposit_opt<!--敷金<br>未定相談等--></th>
		<th scope="col" col="f_price_m_shiki" class="w" style="background: #FFB8B9">敷金<br>ヶ月</th>
		<th scope="col" col="f_price_t_shiki" class="w" style="background: #FFB8B9">敷金<br>坪単価</th>
		<th scope="col" col="f_price_a_shiki" class="w" style="background: #FFB8B9">敷金<br>総額</th>
		<th scope="col" col="f_price_keymoney_opt" class="w" style="background: #FFB8B9">key_money_opt<!--礼金<br>未定相談等--></th>
		<th scope="col" col="f_price_keymoney" class="w" style="background: #FFB8B9">礼金<br>ヶ月</th>
		<th scope="col" col="f_price_rerent_opt" class="w" style="background: #FFB8B9">renewal_fee_opt<!--更新料<br>未定相談等--></th>
		<th scope="col" col="f_price_rerent" class="w" style="background: #FFB8B9">更新料<br>ヶ月</th>
		<th scope="col" col="f_price_amo_opt" class="w" style="background: #FFB8B9">repayment_opt<!--償却<br>未定相談等--></th>
		<th scope="col" col="f_price_amo" class="w" style="background: #FFB8B9">償却</th>
		<th scope="col" col="f_price_amo_flag" class="w" style="background: #FFB8B9">償却<br>単位</th>
		<th scope="col" col="f_amo_memo" class="w">償却<br>備考</th>
		<th scope="col" col="f_price_amo_timeflag" class="w" style="background: #FFB8B9">償却<br>現賃料・新賃料フラグ</th>
		<th style="width:1px; background-color:#333;" ></th>
...
<!-- 		<th scope="col" col="f_lightline" class="w">光ケーブル</th> -->
		...
		<th scope="col" col="f_regloan_year_optcheck" class="w" style="background: #FFB8B9">contract_period_optchk<!--契約年数相談--></th>
	...
	<tr f_no="<?=$fid?>" f_emp="0" class="floorlist ">
		...
		<td f_no="<?=$fid?>" col="f_price_keymoney" od="<?=$floor->key_money_month?>"  class="w edit" style="" scope="col"><?=$floor->key_money_month?></td><!--new-->
		...
		<td f_no="<?=$fid?>" col="f_price_rerent" od="<?=$floor->renewal_fee_recent?>"  class="w edit" style="" scope="col"><?=$floor->renewal_fee_recent?></td><!--new-->
		...
		<td f_no="<?=$fid?>" col="f_price_amo" od="<?=$floor->repayment_amt?>"  class="w edit" style="" scope="col"><?=$floor->repayment_amt?></td><!--new-->
		<td f_no="<?=$fid?>" col="f_price_amo_flag" od="<?=$floor->repayment_amt_opt?>"  class="w edit" style="" scope="col"><?=$floor->repayment_amt_opt?></td>
...
<!-- 	<td f_no="1018756" col="f_lightline" od="0"  class="w edit" style="" scope="col">0</td> -->
		...
		<td f_no="<?=$fid?>" col="f_regloan_year_check" od="<?=$floor->contract_period_optchk?>"  class="w edit" style="" scope="col" style="background: #FFB8B9"><?=$floor->contract_period_optchk?></td><!--new-->
