...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'floor_source_from_type_id'); ?>
		<?php echo $form->textField($model,'floor_source_from_type_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'floor_source_from_type_name'); ?>
		<?php echo $form->textField($model,'floor_source_from_type_name',array('size'=>60,'maxlength'=>255)); ?>
	</div>
