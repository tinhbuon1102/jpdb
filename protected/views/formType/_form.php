...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'form_type_name'); ?>
		<?php echo $form->textField($model,'form_type_name',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'form_type_name'); ?>
	</div>
