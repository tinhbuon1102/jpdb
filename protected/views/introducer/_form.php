...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'introducer_name'); ?>
		<?php echo $form->textField($model,'introducer_name',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'introducer_name'); ?>
	</div>
