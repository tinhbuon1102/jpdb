...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'quake_resistance_standard_id'); ?>
		<?php echo $form->textField($model,'quake_resistance_standard_id'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'quake_resistance_standard_name'); ?>
		<?php echo $form->textField($model,'quake_resistance_standard_name',array('size'=>60,'maxlength'=>255)); ?>
	</div>
