  ...
  <div class="clear"></div>
	<div class="recent-pro">
		<?php
            ...
            $last3Year = date("Y",strtotime("-3 year"));
        ...
        ?>
        <h2 class="recent_text">
			<?php echo Yii::app()->controller->__trans('LATEST(within 3years) BUILDINGS'); ?>
        </h2>
        ...
        <div class="images_part">
            <a href="<?php echo Yii::app()->createUrl('building/searchBuildingResult',array('id'=>$builds['building_id'])); ?>">
                <div class="images_one">
                    ...
                    ?>
                        <img src="<?php echo Yii::app()->baseUrl.'/buildingPictures/front/'.$buildPics[0]; ?>" class="flate_two"/>
                    <?php }else{ ?>
                        <img src="<?php echo Yii::app()->baseUrl.'/images/default.png'; ?>" class="flate_two"/>
                    <?php } ?>
                </div>
                <div class="image_textpart">
                    <h2 class="timage_title_text">
                        <?php echo $builds['name']; ?>
                    </h2>
