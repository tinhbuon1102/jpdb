   	...
   	<div class="header-bg divSearchCondition">
     	<div class="filter-keywords">
      	<div class="searchform-param">
      		<label class="searchform-label date-update Floor-title">Keywords</label>
      		<span class="searchform-input-wrapper select-numbers search-floor">
      			<input type="search" name="keyword" id="keyword" value="" placeholder="キーワードで検索" class="form-control Typeahead-input">
      		</span>
      	</div>
      	</div>
      	...
      	<div class="searchform-param">
      		...
      		<span class="searchform-input-wrapper select-numbers search-floor">
      			<input type="checkbox" value="" id="district1" name="location" class="checkbox-formtype chck_space">District1
      			<input type="checkbox" value="" id="district2" name="location" class="checkbox-formtype chck_space">District2
      			<input type="checkbox" value="" id="district3" name="location" class="checkbox-formtype chck_space">District3
      			<input type="checkbox" value="" id="district4" name="location" class="checkbox-formtype chck_space">District4
      			<input type="checkbox" value="" id="district5" name="location" class="checkbox-formtype chck_space">District5
      			<input type="checkbox" value="" id="district6" name="location" class="checkbox-formtype chck_space">District6
      		</span>
      	</div>
      	</div>
        	...
        	<div class="form_part col_1">
            	<div class="col_wrap">
                    ...
                    <div class="second_part">
                    	<div class="TextField">
                        	<div class="searchform-param">
                            	<label class="searchform-label date-update">更新日</label>
                                <span class="searchform-input-wrapper select-numbers search-floor">
								                                	<select name="updateDateDrop" id="updateDateDrop" data-role="none" class="date-drop">
                                    	<option value="0">-</option>
										                                        <option value="2017-07-28~u">
										2017.07.28 更新物件(10)                                        </option><option value="2017-07-27~u">
										2017.07.27 更新物件(33)                                        </option><option value="2017-07-26~u">
										2017.07.26 更新物件(61)                                        </option><option value="2017-07-25~u">
										2017.07.25 更新物件(19)                                        </option><option value="2017-07-24~u">
										2017.07.24 更新物件(38)                                        </option><option value="2017-07-21~u">
										2017.07.21 更新物件(59)                                        </option><option value="2017-07-20~u">
										2017.07.20 更新物件(24)                                        </option><option value="2017-07-19~u">
										2017.07.19 更新物件(24)                                        </option><option value="2017-07-18~u">
										2017.07.18 更新物件(17)                                        </option>
										                                        <option value="2017-07-18~a">
										2017.07.18 新着物件(27)                                        </option><option value="2017-07-19~a">
										2017.07.19 新着物件(34)                                        </option><option value="2017-07-21~a">
										2017.07.21 新着物件(29)                                        </option><option value="2017-07-24~a">
										2017.07.24 新着物件(4)                                        </option><option value="2017-07-25~a">
										2017.07.25 新着物件(8)                                        </option><option value="2017-07-26~a">
										2017.07.26 新着物件(31)                                        </option><option value="2017-07-27~a">
										2017.07.27 新着物件(7)                                        </option><option value="2017-07-20~a">
										2017.07.20 新着物件(1)                                        </option>
										                                        <option value="2017-07-18~r">
											2017.07.18 非募集になった物件(18)                                        </option><option value="2017-07-19~r">
											2017.07.19 非募集になった物件(27)                                        </option><option value="2017-07-21~r">
											2017.07.21 非募集になった物件(16)                                        </option><option value="2017-07-24~r">
											2017.07.24 非募集になった物件(3)                                        </option><option value="2017-07-25~r">
											2017.07.25 非募集になった物件(5)                                        </option><option value="2017-07-26~r">
											2017.07.26 非募集になった物件(16)                                        </option><option value="2017-07-27~r">
											2017.07.27 非募集になった物件(5)                                        </option>
                                        <option value="">-</option>
                    ...
                    <div class="second_part">
                    	<div class="TextField">
                        	<div class="searchform-param">
                                ...
                                <span class="searchform-input-wrapper select-numbers search-floor">
								<select name="possibleDataMin">
 <option value="0">-</option>	<option value="2017/07"> 2017年07月</option>
 ...
 <option value="0">-</option>	<option value="2017/07"> 2017年07月</option>
	...
	<option value="2019/12"> 2019年12月</option>
            ...
            <div class="form_part col_3">
            	<div class="col_wrap">
                    ...
                    <div class="second_part">
                    	<div class="TextField">
                        	<div class="searchform-param">
                            	<label class="searchform-label date-update status-title ">募集状況</label>
                                <span class="searchform-input-wrapper select-numbers search-floor">
                                	<input type="checkbox" value="1" id="slideThree" name="statusRequirement[]">募集中
                                    <input type="checkbox" value="2" id="slideThree" name="statusRequirement[]" class="checkbox-one">1年以内に空き予定
                                    <input type="checkbox" value="3" id="slideThree" name="statusRequirement[]" class="checkbox-one">満室
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="second_part">
                    	<div class="TextField">
                        	<div class="searchform-param">
                            	<label class="searchform-label date-update">手数料</label>
                                <span class="searchform-input-wrapper select-numbers search-floor">
                                	<input type="checkbox" value="1" id="slideThree" name="brokerageFree">手数料有りの物件のみ
                                </span>
                            </div>
                        </div>
                    </div>
   		...
   		<div class="searchform-controls clearfix">
   			<div class="bt-refine"><input type="button" name="search" id="search_hidden_submit" value="Filter"></div>
   			<div class="refine-more">
                        	<input type="button" class="result_hidden_button" value="Show more options" style="display: inline-block;">
                            <input type="button" class="result_hidden_button" value="Hide options" style="display: none;">
                       	</div>
   		</div>
   	</div>
   </div>
                        	...
                        	<tr>
								...
								<?php
                                	...
                                	if (isset($front_only) && $front_only) {
                                		$floorListCriteria->addInCondition("show_frontend", array(1));
        							}
