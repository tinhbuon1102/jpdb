...
<!--              	<a href="<?php echo Yii::app()->createUrl('building/update',array('id'=>$buildingList['building_id'])); ?>"> -->
                	<a href="<?php echo Yii::app()->createUrl('floor/viewFloorMass',array('id'=>$buildingList['building_id'])); ?>" 
                ...
                <div class="bulk" style="margin-right:1%;">
                	<a href="<?php echo Yii::app()->createUrl('floor/create',array('bid'=>$buildingList['building_id'])); ?>">
